class User < ActiveRecord::Base
  attr_accessible :email, :first_name, :last_name, :notes, :phonetic, :recording, :salt, :password_confirmation, :password, :admin, :customer, :invite_token, :event_code, :customer_id, :company, :password_reset_token, :event_type
